            ...
            <div v-scroll-animate class="fade-in-left p-5 lg:w-1/2 lg:p-0">
                <div class="lg:pl-5 xl:pl-50 lg:pt-25 xl:pt-35">
                    ...
                    <h1 class="lg:text-[16px] xl:text-[20px] text-[#535353] dark:text-[#C8CCD2] font-normal leading-[2] lg:py-5 xl:py-5">
                        ...
                        now be instantly accessed, searched and interpreted.
                    </h1>
    ...
    <div class="p-5">
        <div class="w-full lg:w-[80%] xl:w-[45%] text-center mx-auto">
            ...
            <h1 class="text-[14px] lg:text-[18px] xl:text-[20px] text-[#666666] dark:text-[#C8CCD2] font-medium leading-[1.2] mx-auto mt-5">
                ...
                <span class="font-bold text-[#F47625]"> ElasticDocs™</span> data-to-insight features. 
            </h1>
        </div>
        ...
        <div class="w-full lg:w-[90%] xl:w-[60%] mx-auto">
            ...
            <div class="w-full flex flex-col lg:flex-row mx-auto px-0 lg:px-0 xl:px-10">
                <div class="lg:w-2/5 flex justify-center">
                    <img src="/images/bon1.png">
                </div>
                <div class="lg:w-3/5 pl-3 lg:px-5 pt-0 lg:pt-10">
                    ...
                    <p class="lg:text-[22px] lg:mt-2 text-[#666666] dark:text-[#C8CCD2] font-medium leading-[1.7] w-full">
                        ...
                        and when they are released. You are guaranteed 
                        to have the current database available at your 
                        fingertips.
                    </p>
