<template>
    <div class="px-5 lg:px-0">
        <div class="w-full mx-auto flex flex-col sm:flex-row">
            ...
            <div class="lg:w-1/2 py-4 lg:py-0">
                <img src="https://demoiraya.bicoluni-busina.com/wp-content/uploads/2025/05/DA-1-2048x1816.webp" class="w-auto" alt="Image">
            </div>
        </div>
        ...
        <div class="w-full">
            ...
            <div v-scroll-animate class="fade-in-up w-full py-5 lg:py-15">
                <div class="grid grid-cols-2 place-items-center gap-4 lg:flex lg:flex-row lg:items-center lg:justify-center lg:gap-10 xl:gap-20">
                    ...
                    <img src="https://demoiraya.bicoluni-busina.com/wp-content/uploads/2025/05/tech_3.png" class="w-auto lg:w-50 xl:w-auto" alt="Image">
                    <img src="https://demoiraya.bicoluni-busina.com/wp-content/uploads/2025/05/tech_4-1.png" class="w-auto lg:w-50 xl:w-auto" alt="Image">
                </div>
                <div class="h-5 lg:h-15"></div>
                <h1 class="text-[30px] lg:text-[40px] text-[#2D918C] font-medium text-center">
                    ...and many more
                </h1>
            </div>
        </div>
        ...
        <div v-scroll-animate class="fade-in-up flex flex-col lg:flex-row bg-[#FFFFFF] dark:bg-[#282929] mx-auto p-5 lg:p-10 pb-5 lg:pb-10 rounded-[50px] shadow-[0_10px_40px_rgba(0,0,0,0.3)] align-center w-fit">
            <div class="w-full lg:w-[400px] xl:w-[560px]">
                ...
                <p class="text-[12px] lg:text-[14px] xl:text-[18px] leading-snug lg:mt-5 text-[#666666] dark:text-[#C8CCD2] font-medium w-full lg:w-[90%] pb-2 lg:pb-0">
                    ...
                    cost of production down by ensuring economy-of-scale.
                </p>
            </div>
            <div class="relative w-max mx-auto pt-5 pr-10">
                ...
                <div class="relative z-10 rounded-2xl overflow-hidden">
                    <video controls src="https://demoiraya.bicoluni-busina.com/wp-content/uploads/2025/06/Meet-Data-Atelier-01.mp4" 
                    alt="Data Atelier Video" class="rounded-2xl w-[250px] lg:w-[350px] xl:w-[450px] h-auto"></video>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="w-full lg:w-[80%] xl:w-[60%] mx-auto px-5">
        ...
        <div class="w-full flex flex-col lg:flex-row mx-auto px-0 lg:px-0 xl:px-10">
            <div class="lg:w-2/5 flex justify-center py-5 lg:py-15">
