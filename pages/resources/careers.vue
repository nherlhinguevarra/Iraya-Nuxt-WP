                ...
                <div v-scroll-animate class="fade-in-up shadow-[0_0_15px_rgba(0,0,0,0.25)] rounded-[60px] p-14 mb-5 dark:bg-neutral-900">
                    ...
                    <ul class="font-medium text-sm text-[#535353] list-disc ml-10 mb-8">
                        <li class="mb-5 font-bold">MACHINE LEARNING
                            ...
                            <p class="mt-2">Tech stack: <span class="font-medium">
                                ML Algorithms, Python, SQL, Spark, Git, Cloud Services MLOps
                            </span>
                            </p>
                        </li>
                        <li class="mb-5 font-bold">NATURAL LANGUAGE PROCESSING
                            <p class="mt-2">Roles: <span class="font-medium">
                                Design text analytics solutions for business problems; develop, evaluate, optimize, deploy and maintain text processing and analytics solutions.
                            </span>
                            </p>
                            <p class="mt-2">Tech stack: <span class="font-medium">
                                Python, SQL, Git, NLTK, Deep Learning frameworks, MLOps
                            </span>
                            </p>
                        </li>
                        <li class="mb-5 font-bold">COMPUTER VISION
                            <p class="mt-2">Roles: <span class="font-medium">
                                Design Image and video analytics solutions for business problems; develop, evaluate, optimize, deploy and maintain solutions
                            </span>
                            </p>
                            <p class="mt-2">Tech stack: <span class="font-medium">
                                Tensorflow, OpenCV, Fastai, Pytorch, MLFlow, Spark, MLlib Python, SQL, Git, MLOps
                            </span>
                            </p>
                        </li>
                        <li class="mb-5 font-bold">OPTIMIZATION/SIMULATION
                            <p class="mt-2">Roles: <span class="font-medium">
                                Design optimization and/or simulation analytics solutions for business problems; develop, evaluate, optimize, deploy and maintain solutions
                            </span>
                            </p>
                            <p class="mt-2">Tech stack: <span class="font-medium">
                                mathematical/process models, Simulation modelling, AnyLogic, Simio, Binary/Integer/Linear/Mixed programming, Gurobi, Python, MLOps, etc
                            </span>
                            </p>
                        </li>
                    </ul>
                    ...
                    <ul class="font-medium text-sm text-[#535353] list-disc ml-10">
                        ...
                        <li class="mb-1">Strong background in machine learning and statistics. Solid foundation in data structures and algorithms.</li>
                        <li class="mb-1">Experience deploying and maintaining ML models in production.</li>
                    </ul>
                </div>
