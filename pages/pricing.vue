<template>
    <div class="px-5 lg:px-0">
        <div class="w-full mx-auto flex flex-col sm:flex-row">
            ...
            <div class="lg:w-3/5 py-4 lg:py-0">
                <img src="/images/pricing.png" class="w-full" alt="Image">
            </div>
        </div>
        ...
        <div class="text-center">
            ...
            <div class="w-full lg:w-[95%] xl:w-[60%] flex flex-col lg:flex-row mx-auto gap-5 lg:gap-5 xl:gap-10">
                <div v-scroll-animate class="fade-in-left lg:w-1/2 justify-center shadow-[0_10px_40px_rgba(0,0,0,0.3)] py-12 px-10 rounded-[50px]">
                    ...
                    <div class="flex justify-center">
                        <img src="/images/Apprentice.png" alt="">
                    </div>
                </div>
                ...
                <div class="lg:w-1/2 justify-center shadow-[0_10px_40px_rgba(0,0,0,0.3)] py-12 px-10 rounded-[50px]">
                    ...
                    <h3 class="text-[22px] text-[#F47625] font-regular underline pt-10 cursor-pointer">
                        TALK TO US >
                    </h3>
                </div>
                ...
                <div v-scroll-animate class="fade-in-right lg:w-1/2 justify-center shadow-[0_10px_40px_rgba(0,0,0,0.3)] py-12 px-10 rounded-[50px]">
                    ...
                    <p class="text-left text-[18px] leading-[1.7] py-10 text-[#535353] dark:text-[#C8CCD2] font-regular">
                        ...
                        that will seamlessly fit with your 
        ...
        <div>
            ...
            <div class="w-full lg:w-[90%] xl:w-[55%] mx-auto flex flex-col lg:flex-row gap-5">
                <div v-scroll-animate class="fade-in-left lg:w-1/2 shadow-[0_10px_40px_rgba(245,163,105,0.3)] border-[0.5px] border-[#666666] rounded-[20px] h-full lg:mt-10">
                    ...
                    <div class="text-center border-y-[0.5px] border-[#666666] py-1">
                ...
                <div class="lg:w-1/2 shadow-[0_10px_40px_rgba(45,145,140,0.3)] border-[0.5px] border-[#666666] dark:text-[#C8CCD2] rounded-[20px] lg:mt-10">
                    ...
                    <div class="p-7">
                        <ul class="list-disc pl-5 leading-[1.7] text-[16px] text-[#535353] dark:text-[#C8CCD2] [&>li::marker]:text-[#F47625] space-y-3">
                            ...
                            <li>Create up to <strong>3 project or data sources</strong> toyour team’s account</li>
                            <li>Enjoy <strong>SILVER support</strong> from the Data Atelier team</li>
                        </ul>
                    </div>
                </div>
                ...
                <div v-scroll-animate class="fade-in-right lg:w-1/2 shadow-[0_10px_40px_rgba(254,162,92,0.3)] border-[0.5px] border-[#666666] rounded-[20px]">
                    ...
                    <div class="p-7">
                        <ul class="list-disc pl-5 leading-[1.7] text-[16px] text-[#535353] dark:text-[#C8CCD2] [&>li::marker]:text-[#F47625] space-y-3">
                            ...
                            <li>Create <strong>as many project or data sources</strong> to your organization’s account</li>
                            <li>Enjoy <strong>PLATINUM support</strong> from the Data Atelier team</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div v-for="(section, index) in sections" :key="index" class="w-full lg:w-[90%] xl:w-[60%] mx-auto mb-6">
            ...
            <!-- DATA ATELIER INTERFACE -->
            <div v-if="visibility[index] && section.tableType === 'atelier'" class="p-6 border border-gray-300 transition-all duration-300">
                <h1 class="text-[25px] lg:text-[30px] font-bold">DATA ATELIER INTERFACE</h1>
                <div class="h-3"></div>
                    ...
                    <table class="table-auto w-full border border-gray-300 text-left">
                        <thead class="bg-gray-100 dark:bg-[#545556]">
                            <tr class="text-center">
                                ...
                                <th class="border border-gray-300 p-3 text-[#2D918C] font-bold">BOLT</th>
                        ...
                        <tbody class="text-sm text-[#666666] dark:text-[#C8CCD2]">
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">View and filter file sets table</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">Global corpus search of all processed files</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">Support external additional analysis with search result export and download (extracted images and files)</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
            ...
            <div v-if="visibility[index] && section.tableType === 'warehouse'" class="p-6 border border-gray-300 transition-all duration-300">
                <h1 class="text-[25px] lg:text-[30px] font-bold">DATA WAREHOUSE INTERFACE</h1>
                <div class="h-3"></div>
                <div class="overflow-x-auto">
                    <table class="table-auto w-full border border-gray-300 text-left">
                        <thead class="bg-gray-100 dark:bg-[#545556]">
                        ...
                        <tbody class="text-sm text-[#666666] dark:text-[#C8CCD2]">
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">View and bulk export all extracted images and derived metadata</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">Edit extracted text</td>
                                <td class="border border-gray-300 p-3 text-center">-</td>
                                <td class="border border-gray-300 p-3 text-center">-</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">Edit extracted table information (Convertable data)</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
            ...
            <!-- DATA WAREHOUSE APIS -->
            <div v-if="visibility[index] && section.tableType === 'apis'" class="p-6 border border-gray-300 transition-all duration-300">
                <h1 class="text-[25px] lg:text-[30px] font-bold">DATA WAREHOUSE APIS</h1>
                <div class="h-3"></div>
                <div class="overflow-x-auto">
                    <table class="table-auto w-full border border-gray-300 text-left">
                        <thead class="bg-gray-100 dark:bg-[#545556]">
                        ...
                        <tbody class="text-sm text-[#666666] dark:text-[#C8CCD2]">
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">Query all extracted text (from text elements)</td>
                                <td class="border border-gray-300 p-3 text-center">–</td>
                                <td class="border border-gray-300 p-3 text-center">✓*</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">READ and EDIT the metadata for non-text/images. Metadata includes aspect_ratio, white_pixel, object_name, thumbnail_object_name</td>
                                <td class="border border-gray-300 p-3 text-center">–</td>
                                <td class="border border-gray-300 p-3 text-center">✓*</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">READ and EDIT conversion metadata of the PDF Files</td>
                                <td class="border border-gray-300 p-3 text-center">–</td>
                                <td class="border border-gray-300 p-3 text-center">✓*</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">READ and EDIT extracted images, their corresponding tags, and probability score for each tagged classes</td>
                                <td class="border border-gray-300 p-3 text-center">–</td>
                                <td class="border border-gray-300 p-3 text-center">✓*</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">READ and EDIT the word frequency outputs for each file</td>
                                <td class="border border-gray-300 p-3 text-center">–</td>
                                <td class="border border-gray-300 p-3 text-center">✓*</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
                    ...
                    <p class="text-sm text-gray-500 mt-2 italic">*Up to 1,000 requests per day</p>
                </div>
            </div>

            <!-- HELMSMAN -->
            <div v-if="visibility[index] && section.tableType === 'helmsman'" class="p-6 border border-gray-300 transition-all duration-300">
                <h1 class="text-[25px] lg:text-[30px] font-bold">HELMSMAN</h1>
                <div class="h-3"></div>
                <div class="overflow-x-auto">
                    <table class="table-auto w-full border border-gray-300 text-left">
                        <thead class="bg-gray-100 dark:bg-[#545556]">
                        ...
                        <tbody class="text-sm text-[#666666] dark:text-[#C8CCD2]">
                            ...
                            <tr>
                                <td class="border border-gray-300 p-3">Access to processing logs of text and images</td>
                                <td class="border border-gray-300 p-3 text-center">–</td>
                                <td class="border border-gray-300 p-3 text-center">-</td>
                                <td class="border border-gray-300 p-3 text-center">✓</td>
                            </tr>
            ...
            <!-- SUPPORT-->
            <div v-if="visibility[index] && section.tableType === 'support'" class="p-6 border border-gray-300 transition-all duration-300">
                <h1 class="text-[25px] lg:text-[30px] font-bold">SUPPORT</h1>
                <div class="h-3"></div>
                <div class="overflow-x-auto">
                    <table class="table-auto w-full border border-gray-300 text-left">
                        <tbody class="text-sm text-[#666666] dark:text-[#C8CCD2]">
                            <tr>
                                ...
                                <td class="border border-gray-300 p-3 text-center">Type</td>
                            </tr>
                            <tr>
                                <td class="border border-gray-300 p-3">BRONZE</td>
                                <td class="border border-gray-300 p-3 text-center">120-96 hours</td>
                                <td class="border border-gray-300 p-3 text-center">Remote</td>
                            </tr>
                            <tr>
                                <td class="border border-gray-300 p-3">SILVER</td>
                                <td class="border border-gray-300 p-3 text-center">96-72 hours</td>
                                <td class="border border-gray-300 p-3 text-center">Remote</td>
                            </tr>
                            <tr>
                                <td class="border border-gray-300 p-3">GOLD</td>
                                <td class="border border-gray-300 p-3 text-center">72-48 hours</td>
                                <td class="border border-gray-300 p-3 text-center">Remote</td>
                            </tr>
                            <tr>
                                <td class="border border-gray-300 p-3">PLATINUM</td>
                                <td class="border border-gray-300 p-3 text-center">48-24 hours</td>
                                <td class="border border-gray-300 p-3 text-center">Remote</td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <div class="bg-[#F3F3F3] dark:bg-[#282929] w-full px-2 lg:px-0">
        ...
        <div>
            <div class="w-full lg:w-[80%] xl:w-[60%] flex mx-auto">
                ...
                <div class="w-1/2 flex">
                    <img src="https://demoiraya.bicoluni-busina.com/wp-content/uploads/2025/05/iStock-529234139-2.png" class="w-auto lg:w-[600px]">
                </div>
            </div>
            <div class="w-full lg:w-[80%] xl:w-[60%] flex mx-auto">
                <div class="w-1/2 flex justify-end">
                    <img src="https://demoiraya.bicoluni-busina.com/wp-content/uploads/2025/05/iStock-529234139-1.png" class="w-auto lg:w-[600px]" alt="Image">
                </div>
    ...
    <div>
        <div class="w-full lg:w-[80%] xl:w-[60%] mx-auto">
            <h1 class="text-[20px] lg:text-[40px] text-[#535353] dark:text-white font-medium text-center leading-[1.2]">
                ...
                The
                <span class="text-[#2D918C] text-[25px] lg:text-[60px]">way you manage your data</span>
                should too.
            </h1>
        </div>
        <div class="h-10 lg:h-15"></div>
       ...
       <div class="w-full lg:w-[90%] xl:w-[70%] mx-auto px-5">
            <div class="h-10 lg:h-15"></div>
            ...
            <div class="w-full flex flex-col lg:flex-row mx-auto px-0 lg:px-0 xl:px-10">
                <div class="lg:w-2/5 flex justify-center py-0 pt-10 lg:py-15">
                    <img src="https://demoiraya.bicoluni-busina.com/wp-content/uploads/2025/05/Data-Atelier-1.png" class="w-full">
                </div>
                <div class="lg:w-3/5 pl-2 lg:pl-10 pt-0 lg:pt-25 xl:pt-30">
...
<script setup>
    ...
    const sections = ref([
        { title: 'DATA ATELIER INTERFACE', tableType: 'atelier' },
        { title: 'DATA WAREHOUSE INTERFACE', tableType: 'warehouse' },
        { title: 'DATA WAREHOUSE APIS', tableType: 'apis' },
        { title: 'HELMSMAN', tableType: 'helmsman' },
        { title: 'SUPPORT', tableType: 'support' }
    ])

    // Array of booleans to track visibility per section
    const visibility = ref(sections.value.map(() => false))
